    ...
    <div className="relative w-full max-w-[430px] mx-auto h-screen max-h-[932px] bg-white overflow-hidden rounded-[54px] shadow-2xl border-8 border-gray-800">
      ...
      <div className="absolute inset-0 w-full h-full">
          ...
          <div className="flex items-center gap-[3px]">
            ...
            <svg width="23" height="15" viewBox="0 0 23 15" fill="none">
              <g clipPath="url(#clip0_291_2519)">
                <path
                  d="M19.5151 14.4102H21.5322C22.0469 14.4102 22.3955 14.0449 22.3955 13.5054V0.904785C22.3955 0.365234 22.0469 0 21.5322 0H19.5151C19.0005 0 18.6436 0.365234 18.6436 0.904785V13.5054C18.6436 14.0449 19.0005 14.4102 19.5151 14.4102Z"
                  fill="black"
                />
                <path
                  d="M13.3062 14.4107H15.3066C15.8213 14.4107 16.1782 14.0454 16.1782 13.5059V4.18408C16.1782 3.64453 15.8213 3.2793 15.3066 3.2793H13.3062C12.7832 3.2793 12.4346 3.64453 12.4346 4.18408V13.5059C12.4346 14.0454 12.7832 14.4107 13.3062 14.4107Z"
                  fill="black"
                />
                <path
                  d="M7.08887 14.4097H9.08936C9.6123 14.4097 9.96094 14.0444 9.96094 13.5049V7.18799C9.96094 6.64844 9.6123 6.2832 9.08936 6.2832H7.08887C6.56592 6.2832 6.21729 6.64844 6.21729 7.18799V13.5049C6.21729 14.0444 6.56592 14.4097 7.08887 14.4097Z"
                  fill="black"
                />
                <path
                  d="M0.871582 14.4102H2.87207C3.39502 14.4102 3.74365 14.0449 3.74365 13.5054V9.77832C3.74365 9.23877 3.39502 8.88184 2.87207 8.88184H0.871582C0.348633 8.88184 0 9.23877 0 9.77832V13.5054C0 14.0449 0.348633 14.4102 0.871582 14.4102Z"
                  fill="black"
                />
              </g>
            </svg>
            ...
            <svg width="20" height="14" viewBox="0 0 20 14" fill="none">
              <path
                d="M9.55546 13.8037C9.73808 13.8037 9.8958 13.7207 10.2195 13.4053L12.2449 11.4629C12.3694 11.3384 12.4026 11.1557 12.2864 11.0063C11.7469 10.3091 10.7259 9.70312 9.55546 9.70312C8.35185 9.70312 7.33085 10.334 6.7913 11.0561C6.7083 11.189 6.7415 11.3384 6.87431 11.4629L8.8914 13.4053C9.21513 13.7124 9.37285 13.8037 9.55546 13.8037Z"
                fill="black"
              />
            </svg>
            ...
            <svg width="31" height="14" viewBox="0 0 31 14" fill="none">
              <path
                d="M4.86287 11.5222H22.8804C23.844 11.5222 24.4169 11.3715 24.7809 11.0074C25.145 10.64 25.3031 10.0638 25.3031 9.09946V4.86897C25.3031 3.89798 25.145 3.32843 24.7843 2.96105C24.4169 2.60033 23.8373 2.44629 22.8804 2.44629H4.93173C3.90263 2.44629 3.30902 2.597 2.95904 2.95772C2.59831 3.3251 2.44019 3.91872 2.44019 4.93041V9.09946C2.44019 10.0738 2.59831 10.64 2.95904 11.0074C3.32642 11.3681 3.90596 11.5222 4.86287 11.5222Z"
                fill="black"
              />
            </svg>
          </div>
        ...
        <button className="absolute left-[15px] top-[529px] w-[35px] h-[34px]">
          ...
          <svg
            className="absolute left-[7px] top-[6px] w-[22px] h-[21px]"
            viewBox="0 0 22 21"
            fill="none"
          >
        ...
        <button className="absolute left-[370px] top-[530px] w-[33px] h-[32px]">
          <svg width="34" height="32" viewBox="0 0 34 32" fill="none">
            ...
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M16.6667 8C14.8257 8 13.3333 9.49238 13.3333 11.3333V17.1667C13.3333 19.0076 14.8257 20.5 16.6667 20.5C18.5076 20.5 20 19.0076 20 17.1667V11.3333C20 9.49238 18.5076 8 16.6667 8Z"
              fill="white"
            />
            <path
              d="M11.6667 15.5C11.6667 15.0398 11.2936 14.6667 10.8333 14.6667C10.3731 14.6667 10 15.0398 10 15.5V17.1667C10 20.5669 12.5455 23.3726 15.8349 23.7819C15.8339 23.7989 15.8333 23.8161 15.8333 23.8333V24.6667H13.3333C12.8731 24.6667 12.5 25.0398 12.5 25.5C12.5 25.9602 12.8731 26.3333 13.3333 26.3333H20C20.4602 26.3333 20.8333 25.9602 20.8333 25.5C20.8333 25.0398 20.4602 24.6667 20 24.6667H17.5V23.8333C17.5 23.8161 17.4995 23.7989 17.4984 23.7819C20.7878 23.3726 23.3333 20.5669 23.3333 17.1667V15.5C23.3333 15.0398 22.9602 14.6667 22.5 14.6667C22.0398 14.6667 21.6667 15.0398 21.6667 15.5V17.1667C21.6667 19.9281 19.4281 22.1667 16.6667 22.1667C13.9052 22.1667 11.6667 19.9281 11.6667 17.1667V15.5Z"
              fill="white"
            />
          </svg>
        </button>
